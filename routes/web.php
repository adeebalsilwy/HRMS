...
use App\Livewire\HumanResource\Payroll\Salaries;
...
Route::middleware([
    ...
    Route::group(['middleware' => ['role:Admin|HR']], function () {
        Route::prefix('payroll')->group(function () {
            Route::get('/salaries', Salaries::class)->name('payroll-salaries');
            Route::get('/reports', App\Livewire\HumanResource\Payroll\Reports::class)->name('payroll-reports');
        });
    });
    ...
    Route::group(['middleware' => ['role:Admin|AM|HR']], function () {
        Route::get('/assets/reports', App\Livewire\Assets\Reports::class)->name('reports');
    });
});
